...
<head>
    ...
    <title>Kaip pridėti ar pakeisti logotipą?</title>
    <meta content="Kaip pridėti ar pakeisti logotipą?" property="og:title"/>
    <meta name="robots" content="INDEX,FOLLOW"/>
    <meta name="description" content="Kaip pridėti ar pakeisti logotipą?">
    <meta content="Kaip pridėti ar pakeisti logotipą?" property="og:description"/>
    <meta property="og:type" content="website"/>
    <meta content="{{ route('GamintojasOC15') }}" property="og:url"/>
    <meta content="{{ url('assets/img/misc/logo.png') }}" property="og:image"/>
    <link rel="canonical" href="{{ route('GamintojasOC15') }}"/>
    ...
    <meta name="twitter:title" content="Kaip pridėti ar pakeisti logotipą?">

    <meta name="twitter:description" content="Kaip pridėti ar pakeisti logotipą?">
...
<div class="body">
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"
                            class="active"><a itemprop="item" href="{{ route('GamintojasOC15') }}"><span
                                        itemprop="name">Kaip pridėti ar pakeisti logotipą?</span></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1>Kaip pridėti ar pakeisti logotipą?</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="blog-posts single-post">
                    <article class="post post-large blog-single-post">
                        <div class="post-content">
                            <h2 class="heading-primary" itemprop="name"><strong>Kaip pridėti ar pakeisti logotipą?</strong></h2>
                            <div class="post-meta">
                            ...
                            <p><img class="img-responsive" alt="gamintojai opencart" src="{{ url('assets/img/dokumentacija15/katalogas-gamintojai.png') }}" /></p>

                            <ul>
                                <li><strong>Domeno plėtinys:</strong> galite&nbsp; palikti tu&scaron;čią arba jeigu turite modulį SEO generatorius, tuomet jis sugeneruos draugi&scaron;ką URL.</li>
                                <li><strong>Atvaizdas:</strong> pasirinkite atvaizdą i&scaron; serverio arba įkelkite i&scaron; savo kompiuterio.</li>
                                <li><strong>Rū&scaron;iavimo eili&scaron;kumas:</strong> kokia eilės tvarka bus suru&scaron;iuoti gamintojai Jūsų internetinėje parduotuvėje.</li>
                            ...
                            <p><img class="img-responsive" alt="gamintojai opencart" src="{{ url('assets/img/dokumentacija15/gamintojas.png') }}" /></p>
