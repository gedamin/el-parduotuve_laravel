...
<head>
    ...
    <title>Kaip pridėti kategoriją Opencart</title>
    <meta content="Kaip pridėti kategoriją Opencart" property="og:title"/>
    <meta name="robots" content="INDEX,FOLLOW"/>
    <meta name="description" content="Kaip pridėti kategoriją Opencart">
    <meta content="Kaip pridėti kategoriją Opencart" property="og:description"/>
    <meta property="og:type" content="website"/>
    <meta content="{{ route('KategorijaOC20') }}" property="og:url"/>
    <meta content="{{ url('assets/img/misc/logo.png') }}" property="og:image"/>
    <link rel="canonical" href="{{ route('KategorijaOC20') }}"/>
    ...
    <meta name="twitter:title" content="Kaip pridėti kategoriją Opencart">

    <meta name="twitter:description" content="Kaip pridėti kategoriją Opencart">
...
<div class="body">
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"
                            class="active"><a itemprop="item" href="{{ route('KategorijaOC20') }}"><span itemprop="name">Kaip pridėti prekių kategoriją?</span></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1>Kaip pridėti prekių kategoriją?</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="blog-posts single-post">
                    <article class="post post-large blog-single-post">
                        <div class="post-content">
                            <h2 class="heading-primary" itemprop="name"><strong>Kaip pridėti prekių kategoriją?</strong></h2>
                            <div class="post-meta">
                            ...
                            <div class="heading heading-border heading-bottom-border">
                                <h3>Kaip pridėti naują prekių kategoriją?</h3>
                            </div>
                            <ul>
                            ...
                            <p><img class="img-responsive" alt="kaip prideti kategorija opencart" src="{{ url('assets/img/dokumentacija/1kategorija.png') }}" /><br />
                                &nbsp;</p>

                            <hr />
                            <p>www.el-parduotuve.lt - <strong><a href="http://www.el-parduotuve.lt/" title="elektroninių parduotuvių kūrimas">elektroninių parduotuvių kūrimas</a></strong> ir nemokami SEO patarimai.</p>

                            <hr />
                            <h4>Matote kategorijos valdymo langą: Bendrieji:</h4>

                            <p><img class="img-responsive"  alt="kaip prideti kategorija opencart" src="{{ url('assets/img/dokumentacija/2kategorija.png') }}" /></p>

                            <ul>
                                <li>Atkreipkite dėmesį ar Jūsų elektroninė parduotuvė turi vieną ar kelias kalbas.
                                    <ul>
                                        <li>Jeigu turi kelias kalbas, o naudosite tik vieną &ndash; vistiek privaloma užpildyti kategorijos pavadinimą ir Puslapio antra&scaron;tę abiejose kalbose.</li>
                                    </ul>
                                </li>
                                <li><strong>Kategorijos pavadinimas:</strong> Įveskite prekių ar paslaugų kategorijos pavadinimą.</li>
                            ...
                            <p><img class="img-responsive" alt="kaip prideti kategorija opencart" src="{{ url('assets/img/dokumentacija/3kategorija.png') }}" /></p>
                            ...
                            <ul>
                                ...
                                <li><strong>Parduotuvės: </strong>Palikite Numatytąją parinktį.</li>
                                <li><strong>Domeno URL plėtinys:</strong>
                                    <ul>
                                        ...
                                        <li>Galite ir patys pildyti, tačiau kiekviena kategorija privalo turėti skirtingą URL galūnę (SEO raktažodžius) (atskiriami brūk&scaron;neliu -&nbsp;ir be tarpų, bei nenaudoti lietuvi&scaron;kų raidžių. Neteisingai užpildžius gali ir nerodyti Jūsų&nbsp; kategorijos. Pildymo pvz.: <em>nesiojamu-kompiuteriu-priedai.</em></li>
                                    </ul>
                                </li>
                                <li><strong>Atvaizdas:</strong> Spauskite nar&scaron;yti ir i&scaron;okusiame lange pasirinkite norimą paveiksliuką i&scaron; savo serverio (nuotraukas į serverį lengvai įkelsite paspaudę mygtuką įkelti).</li>
                                ...
                                <li><strong>Rikiavimo eili&scaron;kumas:</strong> kurioje vietoje bus i&scaron;dėstyta kategorija.</li>
                            ...
                            <p><img class="img-responsive" alt="kategorija opencart" src="{{ url('assets/img/dokumentacija/4kategorija.png') }}" /></p>

                            <p><strong>I&scaron;dėstymo perra&scaron;ymas:</strong> Kuriant kategoriją pasirinkite kategorijų puslapis. Reikia tam, kad jeigu Jūs norėsite pridėti papildomą modulį, na pavyzdžiui Skaidrinę reklamą, tuomet nuėję į plėtiniai &ndash; moduliai &ndash; skaidrinės reklamos ir ten galėsite pasirinkti, kur norėtumėte, kad Jūsų skaidrinė reklama būtų i&scaron;dėstyta.</p>
                        </div>
                    </article>
                </div>
            </div>
