...
<head>
    ...
    <meta content="{{route('dokumentacija')}}" property="og:url"/>
    <meta content="{{ url('assets/img/misc/logo.png') }}" property="og:image"/>
    <link rel="canonical" href="{{route('dokumentacija')}}"/>
    ...
    <div role="main" class="main">
        <section class="page-header">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1>Elektroninės parduotuvės dokumentacija</h1>
                    </div>
                </div>
            </div>
        </section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h3>Elektroninės parduotuvės <strong>dokumentacija</strong></h3>
