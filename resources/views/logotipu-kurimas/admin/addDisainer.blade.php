            ...
            <div class="" id="tab-general">
                <form action="{{ route('logotipu-dizaineriai.admin.insert') }}" method="POST"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="disainer_description" id="disainer_description" class="form-control" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="file" name="disainer_avatar" id="disainer_avatar" class="form-control" value="">
                        </div>
                    </div>
