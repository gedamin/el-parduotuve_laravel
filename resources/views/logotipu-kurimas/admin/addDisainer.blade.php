    ...
    <div class="panel-body" xmlns:v-on="http://www.w3.org/1999/xhtml">
        ...
        <div class="tab-content">
            <div class="" id="tab-general">
                <form action="{{ route('logotipu-dizaineriai.admin.insert') }}" method="POST"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="disainer_name" id="disainer_name" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-name">Tipas</label>
                        <div class="col-sm-10">
                            <input type="text" name="disainer_title" id="disainer_title" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group required">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="8"  type="text" name="disainer_description" id="disainer_description" class="form-control"></textarea>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="file" name="disainer_avatar" id="disainer_avatar" class="form-control"
                                   value="">
                            <span class="info">Kad tinkamai atvaizduotų Jūsų avatarą, jis privalo būti kvadrato formos.
                        </div>
                    </div>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-name">Tel. Nr.</label>
                        <div class="col-sm-10">
                            <input type="text" name="disainer_phone" id="disainer_phone" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-name">El. Paštas</label>
                        <div class="col-sm-10">
                            <input type="text" name="disainer_email" id="disainer_email" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group required">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="disainer_sort" id="disainer_sort" class="form-control" value="">
                        </div>
                    </div>
                    @else
                    @endif
