...
<!-- Current Page CSS -->
	...
	<link rel="stylesheet" href="{{ url('assets/vendor/rs-plugin/css/layers.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vendor/rs-plugin/css/navigation.css') }}">
	<link rel="stylesheet" href="{{ url('assets/vendor/circle-flip-slideshow/css/component.css') }}">
