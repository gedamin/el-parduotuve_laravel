...
class LogoDisainer extends Model
{
    ...
    protected $fillable = ['disainer_name', 'disainer_title', 'disainerShort_description','disainer_avatar', 'disainer_phone', 'disainer_email', 'disainer_phone', 'disainer_created', 'is_active_disainer', 'disainer_sort' , 'user_id'];
